...
workDir <- "~/Documents/Bio 364/RNAseq Project 3/SARTools.DESeq2.genes"      # working directory for the R session

projectName <- "SARTools.DESeq2.genes"                         # name of the project
author <- "Ian Vogel"                                # author of the statistical analysis/report

targetFile <- "../SARtools/genes.target.txt"                           # path to the design/target file
